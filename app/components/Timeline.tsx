...
const timelineEvents = [
  {
    year: 2018,
    title: 'Deun Studio Founded',
    description:
      'Our journey began with a passion for minimal design and floral artistry.',
    details:
      "Founded by Jane Doe and John Smith, Deun Studio started as a small studio in Sydney's Surry Hills, combining their love for minimalist design and botanical beauty.",
  },
  {
    year: 2019,
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='mt-4 text-lg text-muted-foreground'>
            The evolution of Deun Studio through the years
          </p>
        </motion.div>
